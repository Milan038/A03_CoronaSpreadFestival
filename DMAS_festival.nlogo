...
to make-venues
  ...
  ask patches with [ pycor < 4 and pxcor > 5 and pxcor < max-pxcor - 5 ] [
    set pcolor red
  ]

  ; now make toilets to the north.
  ask patches with [ pycor > max-pycor - 2 and pxcor > 10 and pxcor < max-pxcor - 10 ] [
    set pcolor orange
  ]
